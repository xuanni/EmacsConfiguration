...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (set-face-attribute 'variable-pitch nil :family "Noto Sans" :foundry "GOOG" :height 142)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (with-eval-after-load 'org-faces
    (dolist (face '((org-level-1 . 1.3)
                    ...
                    (org-level-7 . 1.0)
                    (org-level-8 . 1.0)))
      (set-face-attribute (car face) nil :family "Noto Sans" :foundry "GOOG" :height (cdr face))))
